...
Interpretation::Interpretation(ezechiel::GuiCore::AbstractRepository *repository, QObject *parent) :
    Entity(repository,parent), _intepretationType(InterpretationType::Undefined)
{
    setId(-1);
    _request = ezechiel::GuiCore::CoreFactory::createEntity<InterpretationRequest>(repository, this);
    _analysis = ezechiel::GuiCore::CoreFactory::createEntity<InterpretationAnalysis>(repository, this);
    _drugResponseAnalysis = ezechiel::GuiCore::CoreFactory::createEntity<ezechiel::GuiCore::DrugResponseAnalysis>(repository, this);
    _analyst = ezechiel::GuiCore::CoreFactory::createEntity<Practician>(repository, this);
    _validationStatus = ezechiel::GuiCore::CoreFactory::createEntity<ValidationStatus>(repository, this);
...
AUTO_PROPERTY_IMPL(Interpretation, ezechiel::GuiCore::DrugResponseAnalysis*, drugResponseAnalysis, DrugResponseAnalysis)
...
AUTO_PROPERTY_IMPL(Interpretation, ezechiel::GuiCore::AdjustmentDosage*, selectedAdjustment, SelectedAdjustment)
