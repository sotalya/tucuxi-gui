...
RowLayout {
        ...
        ColumnLayout {
                            ...
                            Image {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        ...
                                        root.entityChanged("editor",currentIndex)
                        ...
                        Item {
                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    ...
                                    border.width: editorList.cellFrameWidth
                                    radius: editorList.cellFrameRadius
                                    color: editorListDelegateMouseArea.hovered ? editorList.rowBackgroundHover : (root.ListView.isCurrentItem ? editorList.rowBackgroundSelected : editorList.rowBackground)
                                    ...
                                    Text {
                                        ...
                                        elide: Text.ElideRight
                                        color: editorListDelegateMouseArea.hovered ? editorList.rowForegroundHover : (root.ListView.isCurrentItem ? editorList.rowForegroundSelected : editorList.rowForeground)
            ...
            Rectangle {
                ...
                ListView {
                    ...
                    onEditionDateChanged: root.editionDate = editionDate
                    onFullNameChanged:  root.editorName      = fullName
                }
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    DatePicker {
                                        ...
                                        onEditingFinished: root.textChanged("date", date.toLocaleDateString(Qt.locale(),"yyyy.MM-dd"))
                                    }
                                ...
                                RowLayout {
                                    ...
                                    TextField {
                                        ...
                                        text: model.institution
                                        onTextChanged: {
                                            root.textChanged("institution",text)
                                        }
                                        font.family:    editor.inputFontFamily
                                        font.pixelSize: editor.inputFontSize
                                        verticalAlignment:   editor.inputVAlign
    ...
    CommentsView {
        commentModel:editorCommentsModel
