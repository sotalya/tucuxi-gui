...
#define QML_POINTERLIST_CLASS_IMPL(NAME, TYPE) \
    NAME::NAME(Tucuxi::Gui::Core::AbstractRepository* repository, QObject* parent) : Tucuxi::Gui::Core::Entity(repository, parent) {} \
    ...
    void NAME::add() { _list.append(Tucuxi::Gui::Core::CoreFactory::createEntity<TYPE>(ABSTRACTREPO, this)); setModified(true); update();} \
...
#define VALUELIST_CLASS_DECL(NAME, TYPE) \
    ...
    public: \
        NAME(Tucuxi::Gui::Core::AbstractRepository* repository, QObject* parent = nullptr); \
        NAME(Tucuxi::Gui::Core::AbstractRepository* repository, QObject* parent, NAME* copyfrom); \
...
#define VALUELIST_CLASS_IMPL(NAME, TYPE) \
    NAME::NAME(Tucuxi::Gui::Core::AbstractRepository* repository, QObject* parent) : Tucuxi::Gui::Core::Entity(repository, parent) {} \
    NAME::NAME(Tucuxi::Gui::Core::AbstractRepository* repository, QObject* parent, NAME* copyfrom) : Tucuxi::Gui::Core::Entity(repository, parent) { _list = copyfrom->getList();} \
...
public: \
 ...
 \
    static entity *createEntity(Tucuxi::Gui::Core::AbstractRepository *repository = nullptr, QObject* parent = nullptr) \
    { \
...
public: \
    ...
    { \
    public: \
        virtual baseclass *createEntity(Tucuxi::Gui::Core::AbstractRepository *repository, QObject *parent = nullptr) \
        { \
...
#define TRANSLATABLE_STRING_PROPERTY_IMPL(CLASS, NAME, UPPERNAME) \
    ...
    Tucuxi::Gui::Core::TranslatableString* CLASS::get ## UPPERNAME ## TranslationMap() const { return _ ## NAME ; } \
...
void CLASS::set ## UPPERNAME ## TranslationMap (Tucuxi::Gui::Core::TranslatableString *map) { \
    _ ## NAME = map; \
    _isModified = true; \
}
...
#define TRANSLATABLE_STRING_PROPERTY_DECL(NAME, UPPERNAME) \
    ...
    Tucuxi::Gui::Core::TranslatableString* get ## UPPERNAME ## TranslationMap() const; \
    void set ## UPPERNAME (const QString &language, const QString &value); \
    void set ## UPPERNAME (const QString &value); \
    void set ## UPPERNAME ## TranslationMap (Tucuxi::Gui::Core::TranslatableString *map); \
    Q_SIGNAL void NAME ## Changed(); \
    private: \
        Tucuxi::Gui::Core::TranslatableString *_ ## NAME;
