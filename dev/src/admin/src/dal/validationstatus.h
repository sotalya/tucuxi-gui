...
public:
    ...
    [[nodiscard]] Q_INVOKABLE StatusType getStatus(Tucuxi::Gui::Admin::StepType::Enum step) const;
    //    Q_INVOKABLE void setStatus(StepType step, StatusType type);

    [[nodiscard]] Q_INVOKABLE DataStatusType
    getDataStatus(Tucuxi::Gui::Admin::StepType::Enum step) const;
    [[nodiscard]] Q_INVOKABLE ValidationStatusType
    getValidationStatus(Tucuxi::Gui::Admin::StepType::Enum step) const;
    ...
    [[nodiscard]] Q_INVOKABLE bool getEnable(Tucuxi::Gui::Admin::StepType::Enum step) const;
