...
QString DrugToHtml::drugToHtml(const Tucuxi::GuiCore::DrugModel *drug)
{
    if (drug) {
        QString desc;
        ...
        Tucuxi::GuiCore::ActiveSubstance *substance = drug->getActiveSubstance();
...
QString DrugToHtml::activeSubstanceToHtml(const Tucuxi::GuiCore::ActiveSubstance *drug)
{
    if (drug) {
        QString desc;
