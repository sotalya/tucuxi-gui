...
/*
* This file was automatically generated Wed Mar 30 16:44:59 2016 UTC by
* rob@rob-All-Series running './configure.py --gen-amalgamation --cpu=armv5te --os=linux --cc=gcc --disable-sse2 --disable-ssse3 --disable-aes-ni --disable-altivec --disable-movbe'
*
* Target
*  - Compiler: g++ -O3 -finline-functions -march=armv5te
*  - Arch: armv5te/arm
*  - OS: linux
*/
...
#define BOTAN_VERSION_PATCH 12
#define BOTAN_VERSION_DATESTAMP 20160203

#define BOTAN_VERSION_VC_REVISION "git:94a3fa8ae0dc4df67f6e9ba780427e651baa9dfd"
...
#define BOTAN_TARGET_CPU_IS_ARMV5TE
