...
TEST(PendingRequestTest, Test1)
{
    ...
    //    for (int i = 0; i < 10; i++){                     // Trying to select specific request by pressing arrows, but can't double click after this step...
    //    srv->enterKey(spix::ItemPath("mainWindow/requestView"), spix::KeyCodes::Up, 0);
    //    srv->waitPeriod(waitTime1);
    //    }
