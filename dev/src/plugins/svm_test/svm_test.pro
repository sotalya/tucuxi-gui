...
#Plugin ID
PLUGIN_ID=ch.heig-vd.ezechiel.svmpred_test
...
DEFINES += SVMPRED_ID=\\\"$${PLUGIN_ID}\\\" \
           ...
           DB_TRAIN_PATH=\\\"plugins/svm_test/$${DB_TRAIN_FILE}\\\" \
           DB_TEST_PATH=\\\"plugins/svm_test/$${DB_TEST_FILE}\\\"
