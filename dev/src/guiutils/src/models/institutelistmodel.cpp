...
void InstituteListModel::insertRowsImpl(int at, int count, const ezechiel::core::SharedEntitySet &entities)
{
...
ezechiel::core::SharedEntitySet InstituteListModel::removeRowsImpl(int at, int count)
{
