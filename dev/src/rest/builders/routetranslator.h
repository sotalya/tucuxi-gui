...
public:
    ...
    virtual Tucuxi::Gui::Core::DMAdmin::Route restToInternalRoute(QString restRoute) = 0;
};
...
public:
    ...
    virtual Tucuxi::Gui::Core::DMAdmin::Route restToInternalRoute(QString restRoute) ;
};
...
private:
    QMap<QString,Tucuxi::Gui::Core::DMAdmin::Route> map;
};
