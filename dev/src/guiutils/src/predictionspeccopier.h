...
public:
    ...
    Tucuxi::Gui::Core::DMAdmin* copy(Tucuxi::Gui::Core::DMAdmin* admin, QObject *parent=0);
    ...
    Tucuxi::Gui::Core::DMAdminList* copy(Tucuxi::Gui::Core::DMAdminList* history, QObject *parent=0);
