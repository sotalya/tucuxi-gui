...
void Core::init()
{
    ...
    if (!data.exists()) {
        ...
        LOG(QtDebugMsg, Tucuxi::Gui::Core::NOEZERROR, QObject::tr("Copying the global directory to the local one (%1 -> %2)").arg(global,data.path()));
...
Tucuxi::Gui::Core::AbstractRepository *Core::repository()
{
