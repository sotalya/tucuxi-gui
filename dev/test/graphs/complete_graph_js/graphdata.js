...
//
export class GraphPercentileDataList {
...
// with Qt Objects
export class GraphPredictionResult {
    constructor() {
...
// displayed or not.
export class GraphInformationSelection {
    constructor() {
...
export class GraphIdentifiableAmount {
...
export class GraphTargetMethod {
    constructor(value = 0) {
        this.value = value;
    }
}
...
export function preparePrediction(prediction, predType) {
...
// This function is also available in Chart.qml
export function preparePercs(pairs) {
