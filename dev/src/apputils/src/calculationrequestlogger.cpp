...
void CalculationRequestLogger::log(ezechiel::core::PredictionSpec *spec)
{
    ...
    if (!f.open(QFile::WriteOnly)) {
        EXLOG(QtWarningMsg, ezechiel::core::ACCESSDENIED, QObject::tr("Can not log processing requests."));
        return;
    }
