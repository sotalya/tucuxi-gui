...
AUTO_PROPERTY_IMPL(InterpretationRequest, ezechiel::core::DrugTreatment*, treatment, Treatment)
...
InterpretationRequest::InterpretationRequest(ezechiel::core::AbstractRepository *repository, QObject *parent) :
    Entity(repository,parent)
{
    ...
    _treatment = ezechiel::core::CoreFactory::createEntity<ezechiel::core::DrugTreatment>(repository, this);
    _clinicals = AdminFactory::createEntity<ClinicalSet>(repository, this);
}

InterpretationRequest::InterpretationRequest(ezechiel::core::AbstractRepository *repository, const int &id, QObject *parent) :
