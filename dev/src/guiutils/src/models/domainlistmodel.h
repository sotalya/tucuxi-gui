...
public:
    ...
    explicit DomainListModel(QObject *parent = nullptr);
    explicit DomainListModel(QUndoStack *undoStack, QObject *parent = nullptr);
...
public slots:
    void setModelData(const QList<ezechiel::GuiCore::Descriptor> &domains);

private:
    void init();

    QList<ezechiel::GuiCore::Descriptor> _domains;
