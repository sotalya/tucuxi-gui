...
class Interpretation : public ezechiel::core::Entity
{
public:
    ...
    AUTO_PROPERTY_DECL(ezechiel::core::DrugResponseAnalysis*, drugResponseAnalysis, DrugResponseAnalysis)
    ...
    AUTO_PROPERTY_DECL(ezechiel::core::AdjustmentDosage*, selectedAdjustment, SelectedAdjustment)
