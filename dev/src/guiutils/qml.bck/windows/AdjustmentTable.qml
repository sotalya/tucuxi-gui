...
Rectangle {
    id: root
    color: "transparent"
    property alias currentItem: adjustmentsTable.currentItem

    //The dosages filters
    ProxyModelFilter {
        id: patientIdFilter
        role: AdjustmentListModel.PatientIdRole
        value: tab_patient.patientid
    }

    ProxyModelFilter {
        id: drugIdFilter
        role: AdjustmentListModel.DrugIdRole
        value: tab_drug.drugid
    }

    ProxyModelFilter {
        id: predictionIdFilter
        role: AdjustmentListModel.PredictionIdRole
...
//        onValueChanged: console.log("flowmodel predictionid: " + value)
    ...
    ProxyModelFilter {
        id: takenFilter
        role: AdjustmentListModel.TakenRole
        value: false
    }

    ProxyModelFilter {
        id: routeFilter
        role: AdjustmentListModel.RouteRole
    }

    ProxyModelFilter {
        id: valueFilter
        role: AdjustmentListModel.ValueRole
    }

    ProxyModelFilter {
        id: fromAppliedFilter
        role: AdjustmentListModel.AppliedRole
    ...
    ProxyModelFilter {
        ...
        role: AdjustmentListModel.EndtimeRole
        value: Qt.formatDateTime(Date())
        operation: ProxyModelFilter.GreaterOrEqual
    }
    ...
    Table {
        ...
        filters: [valueFilter, takenFilter, fromAppliedFilter, toAppliedFilter, fromEndtimeFilter, toEndtimeFilter]
...
//            Layout.fillWidth: true
            ...
            headerData: ListModel {
                ListElement {
                    columnName: "Value";
                    columnWidth: 150;
                    columnRole: AdjustmentListModel.ValueRole
                }
                ListElement {
                    columnName: "Start Date";
                    columnWidth: 150;
                    columnRole: AdjustmentListModel.AppliedRole
                }
                ListElement {
                    columnName: "End Date";
                    columnWidth: 150;
                    columnRole: AdjustmentListModel.EndtimeRole
                }
                ListElement {
                    columnName: "Route";
                    columnWidth: 150;
                    columnRole: AdjustmentListModel.RouteRole
                }
            }

            onAdd: {
                adjustmentListModel.insertRows(adjustmentListModel.rowCount(), 1);
//                adjustmentListModel.setData(adjustmentListModel.index(adjustmentListModel.rowCount(),0),predictionIdFilter.value, AdjustmentListModel.PredictionIdRole)
                adjustmentsTable.currentIndex = adjustmentsTable.count - 1;
//                flowModel.sourceModel.refresh()
            }
                //newDosageDialog.show()
            onSort: adjustmentListModel.sort(role, order)
            onFilter: {
                switch (role) {
                case AdjustmentListModel.ValueRole: valueFilterView.visible = !valueFilterView.visible; break;
                case AdjustmentListModel.AppliedRole:  appliedFilterView.visible  = !appliedFilterView.visible;  break;
                case AdjustmentListModel.EndtimeRole:  endtimeFilterView.visible  = !endtimeFilterView.visible;  break;
                case AdjustmentListModel.RouteRole:  routeFilterView.visible  = !routeFilterView.visible;  break;
                }
            }
        }
        ...
        TableFilter {
            ...
            TimePicker {
                ...
                Layout.fillWidth: true
                onDateChanged: fromAppliedFilter.value = new Date(appliedFilterFromDateInput.date.getFullYear(), appliedFilterFromDateInput.date.getMonth(), appliedFilterFromDateInput.date.getDate(), appliedFilterFromTimeInput.hours, appliedFilterFromTimeInput.minutes)
            }
            ...
            TimePicker {
                ...
                Layout.fillWidth: true
                onDateChanged: toAppliedFilter.value = new Date(appliedFilterToDateInput.date.getFullYear(), appliedFilterToDateInput.date.getMonth(), appliedFilterToDateInput.date.getDate(), appliedFilterFromTimeInput.hours, appliedFilterFromTimeInput.minutes)
            }
        ...
        TableFilter {
            ...
            TimePicker {
                ...
                Layout.fillWidth: true
                onDateChanged: fromEndtimeFilter.value = new Date(endtimeFilterFromDateInput.date.getFullYear(), endtimeFilterFromDateInput.date.getMonth(), endtimeFilterFromDateInput.date.getDate(), endtimeFilterFromTimeInput.hours, endtimeFilterFromTimeInput.minutes)
            }
            ...
            TimePicker {
                ...
                Layout.fillWidth: true
                onDateChanged: toEndtimeFilter.value = new Date(endtimeFilterToDateInput.date.getFullYear(), endtimeFilterToDateInput.date.getMonth(), endtimeFilterToDateInput.date.getDate(), endtimeFilterFromTimeInput.hours, endtimeFilterFromTimeInput.minutes)
            }
...
//            width: ListView.view.width
            ...
            onEdit: state = "edit"
            onRemove: {
                adjustmentListModel.removeRows(index, 1)
                flowModel.sourceModel.refresh()
            }
