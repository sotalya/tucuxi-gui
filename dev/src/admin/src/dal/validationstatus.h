...
class ValidationStatus : public ezechiel::core::Entity
{
    Q_OBJECT
...
public:
    Q_INVOKABLE ValidationStatus(ezechiel::core::AbstractRepository *repository = nullptr, QObject *parent = nullptr);
