...
QVariant CovariateModel::data(const QModelIndex &index, int role) const
{
    ...
    switch (role) {
    case NameRole:
        return _covariate->getCovariateId();
        break;
...
void CovariateModel::setModelData(ezechiel::GuiCore::PatientVariate* covariate)
{
    beginResetModel();
...
void CovariateModel::setDataImpl(const QModelIndex &index, const QVariant &value, int role)
{
    ...
    switch (role) {
    case NameRole:
        _covariate->setCovariateId(value.toString());
        break;
    case DescriptionRole:
    ...
    case ValueRole:
        ...
        break;
    case UnitRole:
        _covariate->getQuantity()->setUnit(ezechiel::GuiCore::Unit(value.toString()));
        break;
    case TypeRole:
