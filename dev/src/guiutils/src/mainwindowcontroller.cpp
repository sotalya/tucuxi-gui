...
//    QString requestFile = SETTINGS.get(ezechiel::GuiCore::Module::GUI, "requestFile").toString();
...
void MainWindowController::goToLoadRequest()
{
    ...
    // Settings to keep track of the previous path
    dirPath = SETTINGS.get(ezechiel::GuiCore::Module::GUI,"requestDirPath", "").toString();
    ...
    dirPath = QFileInfo(fileName).absoluteDir().absolutePath();
    SETTINGS.set(ezechiel::GuiCore::Module::GUI,"requestDirPath", dirPath);
