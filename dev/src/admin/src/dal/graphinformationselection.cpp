...
void GraphInformationSelection::loadDisplayParametersSettings(){
    ...
    QMap<QString, QVariant> displayParameters = SETTINGS.get(Tucuxi::Gui::Core::Module::GUI, "GraphDisplayParameters").toMap();
    ...
    QList<QVariant> percentile = SETTINGS.get(Tucuxi::Gui::Core::Module::GUI, "PercentilesDisplayParameters").toList();
    ...
    QMap<QString, QVariant> generalParameters = SETTINGS.get(Tucuxi::Gui::Core::Module::GUI, "GeneralDisplayParameters").toMap();
...
void GraphInformationSelection::saveSettings(){
    ...
    SETTINGS.set(Tucuxi::Gui::Core::Module::GUI, "GraphDisplayParameters" ,_parametersSettingsMap);

    SETTINGS.set(Tucuxi::Gui::Core::Module::GUI, "PercentilesDisplayParameters" ,percentiles);

    SETTINGS.set(Tucuxi::Gui::Core::Module::GUI, "GeneralDisplayParameters", general);
}
