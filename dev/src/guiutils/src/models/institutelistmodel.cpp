...
void InstituteListModel::insertRowsImpl(int at, int count, const ezechiel::GuiCore::SharedEntitySet &entities)
{
...
ezechiel::GuiCore::SharedEntitySet InstituteListModel::removeRowsImpl(int at, int count)
{
