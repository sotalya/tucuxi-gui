--Location
INSERT INTO Location (id,country,state,address,city,postcode) VALUES ('1','CH','VD','Rue de Lausanne 1', 'Lausanne', '1000');
...
INSERT INTO Location (id,country,state,address,city,postcode) VALUES ('5','CH','VD','Rue du Bugnon 21', 'Lausanne', '1011');

--Institute
INSERT INTO Institute (id,name,Location) VALUES ('1','CHUV','5');

--Four persons
INSERT INTO Person (id,name,firstname,gender,birthday,Location) VALUES ('1','Doe','John','true','1901-01-01','1');
INSERT INTO Person (id,name,firstname,gender,birthday,Location) VALUES ('2','Doe','Jane','false','1902-02-02','2');
INSERT INTO Person (id,name,firstname,gender,birthday,Location) VALUES ('3','Cooper','Sheldon','true','1903-03-03','3');
INSERT INTO Person (id,name,firstname,gender,birthday,Location) VALUES ('4','Banner','Bruce','false','1904-04-04','4');
...
INSERT INTO Covariate (sql_id,value,mid,Patient,date,unit) VALUES ('1','74','weight','1','2001-01-01','kg');
INSERT INTO Covariate (sql_id,value,mid,Patient,date) VALUES ('2','1','gist','1','2002-02-02');

--Covariates for the second patient
INSERT INTO Covariate (sql_id,value,mid,Patient,date,unit) VALUES ('3','95','weight','2','2003-03-03','kg');
