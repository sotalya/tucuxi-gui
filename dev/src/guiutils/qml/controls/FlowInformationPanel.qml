...
Item {
    ...
    property string patientName:      interpretationController.currentPatient ? interpretationController.currentPatient.person.firstname + " " + interpretationController.currentPatient.person.name : ""
