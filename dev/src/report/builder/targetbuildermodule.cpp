...
bool TargetBuilderModule::setData(ReportData *data)
{
    ...
    for (int i = 0; i < _targets.size(); ++i) {
        ...
        data->setValue(QString(ID::Targets::Target::Count).arg(i), target->getType()->getTargetType() == Tucuxi::GuiCore::TargetMethod::PeakTarget ? "2" :  "1");
        ...
        if (target->getType()->getTargetType() == Tucuxi::GuiCore::TargetMethod::PeakTarget) {
