...
QtObject {
    ...
    property QtObject chart: QtObject {
        ...
        readonly property string measuresVisible : qsTr("Display the measures on the graph")
        readonly property string targetsVisible : qsTr("Display the targets on the graph")
