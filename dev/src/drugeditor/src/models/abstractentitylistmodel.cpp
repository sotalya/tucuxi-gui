...
void AbstractEntityListModel::insertRowsImpl(int at, int count, const ezechiel::core::SharedEntitySet &entities)
{
    Q_UNUSED(at);
    Q_UNUSED(count);
    Q_UNUSED(entities);
...
ezechiel::core::SharedEntitySet AbstractEntityListModel::removeRowsImpl(int at, int count)
{
    Q_UNUSED(at);
    Q_UNUSED(count);
    return ezechiel::core::SharedEntitySet();
}
