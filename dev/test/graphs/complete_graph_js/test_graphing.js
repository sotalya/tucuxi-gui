...
import {GraphFullData, GraphDosage, GraphCovariate, GraphMeasure, GraphTarget, 
    GraphPredictionData, preparePrediction, GraphPercentileData,
preparePercs, GraphAdjustments, GraphAdjustment, GraphMouseArea} from './graphdata.js';
...
export function testtarget4() {
    ...
    var expected = "Test of AUC24 target. We shall only see the prediction";
    return {obj, expected};    
}

export function testtarget5() {
    // Creation of all the data necessary for a drawing
    var obj = new GraphFullData();
