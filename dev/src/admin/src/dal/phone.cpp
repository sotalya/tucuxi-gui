...
Phone::Phone(ezechiel::GuiCore::AbstractRepository *repository, QObject *parent) :
...
Phone::Phone(ezechiel::GuiCore::AbstractRepository *repository, const int &id, QObject *parent) :
